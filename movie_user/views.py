...
class IntroPageView(TemplateView):
    template_name = 'movie_user/intro.html'

#######Food Order Page###########
class FoodPageView(TemplateView):
    template_name = 'movie_user/food_order.html'
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            if user.is_superuser:
                ...
                return render(request,'movie/admin_base.html')
            else:
